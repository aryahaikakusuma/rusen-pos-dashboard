-- Rokok bebas PBJT — antrean kirim dari ponsel.
--
-- Berkas ini adalah 0017 dengan TIGA perubahan. Sisanya sengaja disalin utuh,
-- termasuk seluruh komentarnya, supaya perbedaannya bisa dibaca dengan `diff`
-- alih-alih dipercaya begitu saja.
--
--   1. `taxable_subtotal` diterima dan ditulis; basis pemeriksaan pajak
--      berpindah ke sana dari `subtotal`.
--   2. `taxable` per item diterima dan ditulis.
--   3. Penjaga baru TAXABLE_SUM_MISMATCH: jumlah baris kena pajak harus sama
--      dengan taxable_subtotal yang dikirim.
--
-- ============================================================================
