-- Refund — antrean kirim dari ponsel.
--
-- Berkas ini adalah 0014 dengan TIGA perubahan. Sisanya sengaja disalin utuh,
-- termasuk seluruh komentarnya, supaya perbedaannya bisa dibaca dengan `diff`
-- alih-alih dipercaya begitu saja.
--
--   1. Larik `refunds` diterima, divalidasi, dan disisipkan.
--   2. Item TIDAK ditulis ulang untuk order yang di server sudah 'paid'.
--   3. Satu variabel penjaga (v_rewrite_items) yang menghubungkan keduanya.
--
-- ============================================================================
